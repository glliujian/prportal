...
//		sb.append("</div>");
		...
		sb.append("<span class=\"pagination-info\">"+startIndex+" ~ "+ endIndex +" / "+count+" </span>");
		sb.append("<span class=\"page-list\">&nbsp;&nbsp;&nbsp;&nbsp;Page size: <span class=\"btn-group dropup\">");
