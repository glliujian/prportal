...
public class MenuTag extends TagSupport {
	...
	private   String getChildOfTree(Menu parent, int level, List<Menu> menuList) {
		...
		if ((parent.getHref() == null || parent.getHref().trim().equals("")) && parent.getIsShow().equals("1")) {//如果是父节点且显示
			...
			menuString
					.append("<a href=\""
							...
							+ DictUtils.getLanguageLabel(parent.getName())
			...
			menuString.append("<a class=\"J_menuItem\"  href=\"" + href
					+ "\" ><i class=\"fa "+parent.getIcon()+"\"></i> <span class=\"nav-label\">"+DictUtils.getLanguageLabel(parent.getName())+"</span></a>");
		}
		if (level > 0) {
			menuString.append("</li>");
		}
