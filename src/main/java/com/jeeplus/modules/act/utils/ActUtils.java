...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	 ...
	 */
	public static final String[] PD_TRIP_OVERSEA = new String[]{"trip_oversea", "oa_trip"};
	public static final String[] PD_STAY = new String[]{"reservation", "oa_application_for_stay"};
	public static final String[] PD_TRIP = new String[]{"trip", "oa_trip"};
	public static final String[] PD_LEAVE = new String[]{"leave", "oa_leave"};
	public static final String[] PD_PR = new String[]{"pr", "oa_pr"};
	//add by J 20180127 --begin
	public static final String[] PD_PR_OEM = new String[]{"pr_oem", "oa_pr"};
	//add by J 20180127 --end
...
//	}
	...
	public static String getFormUrl(String formKey, Act act){	
		...
		formUrl.append("&act.comment=").append(act.getComment() != null ? Encodes.urlEncode(act.getComment()) : "");
