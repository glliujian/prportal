...
function confirmx(mess, href, closed){
	var titleMessage= top.$("#layerNoticeTitle").val();
	//top.layer.confirm(mess, {icon: 3, title:"系统提示"}, function(index){
	top.layer.confirm(mess, {icon: 3, title:titleMessage}, function(index){
	    //do something
...
function openDialog(title,url,width,height,target){ 
	...
	top.layer.open({
	    ...
	    content: url ,
	    btn: [ top.$("#saveBtn").val(), top.$("#closeBtn").val()],
