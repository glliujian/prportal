...
(function(a)
	...
	a.extend(a.validator.messages,
			{required:"Please input this information",
			remote:"Please correct this information",
			email:"Seems that this is not a valid email, please correct",
			url:"Seems that this is not a valid url address, please correct",
			date:"Seems that this is not a valid date, please correct",
			dateISO:"请输入有效的日期 (YYYY-MM-DD)",
			number:"Seems that this field contains non-numeric, please correct",
			digits:"只能输入数字",
