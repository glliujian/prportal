...
<body class="gray-bg">
	...
	<form:form id="inputForm" modelAttribute="pr" action="${ctx}/oa/pr/save" method="post"  class="form-horizontal"  enctype="multipart/form-data">
		...
		<div style="text-align:center"><font size="6pt">
			...
			<!-- ${fns:getUser().company} -->
			Win Hanverky Group
		</font><br><font size="4pt"><spring:message code="采购申请表（IT 设备）"></spring:message> </font></div>
		...
		<input id="btnSubmit" class="btn btn-primary" type="submit" onclick="$('#flag').val(0)" value="<spring:message code='保存'></spring:message>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
