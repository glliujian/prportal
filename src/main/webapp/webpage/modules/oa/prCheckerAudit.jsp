		...
		<table id="tableContent" class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>	
					...
					<td class="width-35">
						<form:select path="expenseType" id="expenseType" cssClass="form-control input-sm" >
				...
				<td class="width-15 active"><label class="pull-right"><spring:message code="请求者姓名"></spring:message>:</label></td>
					...
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font><spring:message code="地区"></spring:message>:</label></td>
					<td  class="width-35">
				...
				<tr>
					...
					<td class="width-15">
						...
						<input name="unitPrice" id="unitPrice" type="text" class="form-control required number round" htmlEscape="false" onblur="caculateTotal()" value="<fmt:formatNumber value="${pr.unitPrice}" pattern="0.00"/>"/> 
					</td>
					...
					<td class="width-35">
						<form:input path="quantity" id="quantity" htmlEscape="false"   onblur="caculateTotal()"  class="form-control required numebr"/>
					</td>
				</tr>
				<tr>
