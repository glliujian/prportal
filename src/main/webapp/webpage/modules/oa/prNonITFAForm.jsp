...
<body class="gray-bg">
	...
	<form:form id="inputForm" modelAttribute="pr"  action="${ctx}/oa/prNonITFA/save" method="post"  class="form-horizontal"  enctype="multipart/form-data">
		<form:hidden path="id"/>
		<form:hidden id="flag" path="act.flag"/>
		<sys:message hideType="1" content="${message}"/>
		<div style="text-align:center"><font size="6pt">			
			Win Hanverky Group
		</font><br><font size="4pt"><spring:message code="采购申请表（非IT设备）"></spring:message> </font></div>
