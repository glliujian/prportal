...
<html>
<head>
	<title><spring:message code="用户管理"></spring:message></title>
...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="width-15 active">	<label class="pull-right"><font color="red">*</font><spring:message code="头像"></spring:message>：</label></td>
		         ...
		         <td  class="width-15"  class="active">	<label class="pull-right"><font color="red">*</font><spring:message code="归属公司"></spring:message>:</label></td>
		      ...
		      <tr>
		         <td class="active"><label class="pull-right"><font color="red">*</font><spring:message code="归属部门"></spring:message>:</label></td>
		         ...
		         <td class="active"><label class="pull-right"><font color="red">*</font><spring:message code="工号"></spring:message>:</label></td>
		         <td><form:input path="no" htmlEscape="false" maxlength="50" class="form-control required"/></td>
		      </tr>
		      
		      <tr>
		         <td class="active"><label class="pull-right"><font color="red">*</font><spring:message code="姓名"></spring:message>:</label></td>
		         <td><form:input path="name" htmlEscape="false" maxlength="50" class="form-control required"/></td>
		         <td class="active"><label class="pull-right"><font color="red">*</font><spring:message code="登录名"></spring:message>:</label></td>
		      ...
		      <%--<tr>
		         <td class="active"><label class="pull-right"><c:if test="${empty user.id}"><font color="red">*</font></c:if><spring:message code="密码"></spring:message>:</label></td>
		         <td><input id="newPassword" name="newPassword" type="password" value="" maxlength="50" minlength="3" class="form-control ${empty user.id?'required':''}"/>
					<c:if test="${not empty user.id}"><span class="help-inline"><spring:message code="若不修改密码，请留空"></spring:message><spring:message code="。"></spring:message></span></c:if></td>
		         <td class="active"><label class="pull-right"><c:if test="${empty user.id}"><font color="red">*</font></c:if><spring:message code="确认密码"></spring:message>:</label></td>
		       ...
		       <tr>
		         <td class="active"><label class="pull-right"><spring:message code="邮箱"></spring:message>:</label></td>
		         <td><form:input path="email" htmlEscape="false" maxlength="100" class="form-control email"/></td>
		         <td class="active"><label class="pull-right"><spring:message code="电话"></spring:message>:</label></td>
		         <td><form:input path="phone" htmlEscape="false" maxlength="100" class="form-control"/></td>
		      </tr>
		      
		      <tr>
		         <td class="active"><label class="pull-right"><spring:message code="手机"></spring:message>:</label></td>
		         <td><form:input path="mobile" htmlEscape="false" maxlength="100" class="form-control"/></td>
		         <td class="active"><label class="pull-right"><spring:message code="是否允许登录"></spring:message>:</label></td>
		      ...
		      <tr>
		         <td class="active"><label class="pull-right"><spring:message code="职位"></spring:message>:</label></td>
		         <td><form:select path="userType"  class="form-control">
					<form:option value="" label="请选择"/>
						<form:options items="${fns:getDictList('sys_user_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select></td>
		         <td class="active"><label class="pull-right"><font color="red">*</font><spring:message code="用户角色"></spring:message>:</label></td>
		         <td>
		       ...
		       <tr>
		         <td class="active"><label class="pull-right"><spring:message code="备注"></spring:message>:</label></td>
		      ...
		      <c:if test="${not empty user.id}">
		       <tr>
		         <td class=""><label class="pull-right"><spring:message code="创建时间"></spring:message>:</label></td>
		         <td><span class="lbl"><fmt:formatDate value="${user.createDate}" type="both" dateStyle="full"/></span></td>
		         <td class=""><label class="pull-right"><spring:message code="最后登录"></spring:message>:</label></td>
		         <td><span class="lbl">IP: ${user.loginIp}&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="时间"></spring:message>：<fmt:formatDate value="${user.loginDate}" type="both" dateStyle="full"/></span></td>
		      </tr>
		     </c:if>
