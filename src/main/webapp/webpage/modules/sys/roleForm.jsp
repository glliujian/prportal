...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="role" autocomplete="off" action="${ctx}/sys/role/save" method="post" class="form-horizontal" >
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><spring:message code="归属机构"></spring:message>:</label></td>
		         ...
		         <td  class="width-15" class="active"><label class="pull-right"><font color="red">*</font><spring:message code="角色名称"></spring:message>:</label></td>
		      ...
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><font color="red">*</font><spring:message code="英文名称"></spring:message>:</label></td>
		         ...
		         <td  class="width-15" class="active"><label class="pull-right"><spring:message code="角色类型"></spring:message>:</label></td>
		         <td class="width-35"><%--
					...
					<form:select path="roleType" class="form-control ">
						<form:option value="assignment"><spring:message code="任务分配"></spring:message></form:option>
						<form:option value="security-role"><spring:message code="管理角色"></spring:message></form:option>
						<form:option value="user"><spring:message code="普通角色"></spring:message></form:option>
					</form:select>
					<span class="help-inline" title="activiti有3种预定义的组类型：security-role、assignment、user 如果使用Activiti Explorer，需要security-role才能看到manage页签，需要assignment才能claim任务">
						<spring:message code="工作流组用户组类型（任务分配：assignment、管理角色：security-role、普通角色：user）"></spring:message></span></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><spring:message code="是否系统数据"></spring:message>:</label></td>
		         ...
		         <td  class="width-15" class="active"><label class="pull-right"><spring:message code="是否可用"></spring:message></label></td>
		      ...
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><spring:message code="数据范围"></spring:message>:</label></td>
