...
<body class="gray-bg">
	...
	<div class="ibox-title">
		<h5><spring:message code="流程管理"></spring:message> </h5>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th><spring:message code="流程ID"></spring:message></th>
				...
				<th><spring:message code="流程XML"></spring:message></th>
				<th><spring:message code="流程图片"></spring:message></th>
				<th><spring:message code="部署时间"></spring:message></th>
				...
				<tr>
					...
					<td>
						<c:if test="${process.suspended}">
							<a href="${ctx}/act/process/update/active?procDefId=${process.id}" onclick="return confirmx('<spring:message code="确认要激活吗？"></spring:message>', this.href)"><spring:message code="激活"></spring:message></a>
						</c:if>
						<c:if test="${!process.suspended}">
							<a href="${ctx}/act/process/update/suspend?procDefId=${process.id}" onclick="return confirmx('<spring:message code="确认挂起吗？"></spring:message>', this.href)"><spring:message code="挂起"></spring:message></a>
						</c:if>
						<a href='${ctx}/act/process/delete?deploymentId=${process.deploymentId}' onclick="return confirmx('<spring:message code="确认要删除该流程吗？"></spring:message>', this.href)"><spring:message code="删除"></spring:message></a>
                        <a href='${ctx}/act/process/convert/toModel?procDefId=${process.id}' onclick="return confirmx('<spring:message code="确认要转换为模型吗？"></spring:message>', this.href)"><spring:message code="转换为模型"></spring:message></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
