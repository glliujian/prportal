...
/* 	if(lang==null){
	 	$.ajax({
		    type: "GET",
	        async: false,
	        url: "${ctx}/sys/language/getLanguageMap",
			dataType: "json", 
...
<!-- <script id="messageChoose" src="${ctxStatic}/jquery-validation/1.14.0/localization/messages_zh.min.js" type="text/javascript"></script> --> 
...
<!--  add by J Li 2017-6-1-->
<script src="${ctxStatic}/TableExport/tableExport.js"></script> 
<script src="${ctxStatic}/common/validatePrice.js"></script> 
<!--<script src="${ctxStatic}/TableExport/jquery.base64.js"></script>-->
